...
for (j in 1:length(ep)){
  for (i in 1:78){
    res[i,j]<-sum(p[i,]^n[i])*((1-0.5*exp(-0.5*ep[j]))^2)*(1-0.5*exp(ep[j]*(0.5-n[i])))+
      ifelse(n[i]<2,0,1)*(1-sum(p[i,]^n[i]))*((1-0.5*exp(-0.5*ep[j]))*(1-0.5*exp(ep[j]*(1.5-n[i])))*(0.5*exp(-0.5*ep[j]))+((1-0.5*exp(-0.5*ep[j]))^2)*(0.5*exp((1.5-n[i])*ep[j])))
  }
}
...
for (t in 1:length(eps)){
  ...
  for (i in 1:78){
    DR.0.001[i,t]=(1/8)*((1+erf(1/(2*sqrt(2)*sigma)))^2)*sum(p[i,]^n[i])*(1+erf((n[i]-0.5)/(sigma*sqrt(2))))+
      (1/8)*ifelse(n[i]<2,0,1)*(1-sum(p[i,]^n[i]))*(1+erf(1/(2*sqrt(2)*sigma)))*((1-erf((1.5-n[i])/(sigma*sqrt(2))))*(1+erf(-0.5/((sqrt(2)*sigma))))+(1+erf((1.5-n[i])/(sigma*sqrt(2))))*(1+erf(1/(2*sqrt(2)*sigma))))
 }
}
...
for (t in 1:length(eps)){
  sigma=sqrt(2*log(1.25/delta))/eps[t]
  for (i in 1:78){
    DR.0.01[i,t]=(1/8)*((1+erf(1/(2*sqrt(2)*sigma)))^2)*sum(p[i,]^n[i])*(1+erf((n[i]-0.5)/(sigma*sqrt(2))))+
      (1/8)*ifelse(n[i]<2,0,1)*(1-sum(p[i,]^n[i]))*(1+erf(1/(2*sqrt(2)*sigma)))*((1-erf((1.5-n[i])/(sigma*sqrt(2))))*(1+erf(-0.5/((sqrt(2)*sigma))))+(1+erf((1.5-n[i])/(sigma*sqrt(2))))*(1+erf(1/(2*sqrt(2)*sigma))))
  }
}
...
for (t in 1:length(eps)){
  sigma=sqrt(2*log(1.25/delta))/eps[t]
  for (i in 1:78){
    DR.0.1[i,t]=(1/8)*((1+erf(1/(2*sqrt(2)*sigma)))^2)*sum(p[i,]^n[i])*(1+erf((n[i]-0.5)/(sigma*sqrt(2))))+
      (1/8)*ifelse(n[i]<2,0,1)*(1-sum(p[i,]^n[i]))*(1+erf(1/(2*sqrt(2)*sigma)))*((1-erf((1.5-n[i])/(sigma*sqrt(2))))*(1+erf(-0.5/((sqrt(2)*sigma))))+(1+erf((1.5-n[i])/(sigma*sqrt(2))))*(1+erf(1/(2*sqrt(2)*sigma))))
  }
}
